    ...
    >
      ...
      <div className="z-10">
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          Estou em busca de novas oportunidades e minha caixa de entrada está
          sempre aberta. Se você tiver alguma pergunta ou quiser apenas dizer oi,
          farei o meu melhor para responder!
        </p>
        <div className="socials flex flex-row gap-2">
          <Link href="https://github.com/KevinReisHartwig">
            <Image src={GithubIcon} alt="Ícone do Github" />
          </Link>
          <Link href="https://www.linkedin.com/in/kevin-hartwig-dev/">
