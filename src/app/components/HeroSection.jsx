    ...
    <section className="lg:py-16">
      <div className="grid grid-cols-1 sm:grid-cols-12">
        ...
        >
          ...
          Recém-formado e focado em adquirir experiência prática como desenvolvedor full-stack, pronto para novos desafios.
          </p>
          <div>
            <Link
              href="/#contact"
            ...
            <Link
              href="https://drive.google.com/uc?export=download&id=1T9ZHpdTALLzjXYbs3JtZBuyTit1AqzCY"
